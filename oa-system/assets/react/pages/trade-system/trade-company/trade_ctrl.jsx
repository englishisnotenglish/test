...
class TradeCompanyCtrl extends React.Component {
    ...
    render() {
        ...
        if(this.state.infoItem && this.state.shopType && this.state.areas) {
            infoPanelXml = (
                <div className="info-main-w" style={{height: '435px'}}>
        ...
        return (
            <div className="section-warp">
                ...
                <div className="section-tr-info" style={{height: this.state.infoPanel.infoPanelIsShow ? '500px' : 0}}>
