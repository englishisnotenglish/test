    ...
    createRow(data, index){
        return(
            <tr key={index}>
                ...
                <td>{data.supplier}</td>
                <td>{data.viewed_person}<a href="javascript:;" onClick={this.handleInfoPanel.bind(this, data.goods_id)} style={{color: 'blue'}}>明细</a></td>
    ...
    createTable(){
        ...
        return(
            <div>
                ...
                <Paging maxPage={total%20 == 0 ? total/20 : total/20+1} clickCallback={this.setParentPageNum.bind(this)} />
            </div>
        );
    }
