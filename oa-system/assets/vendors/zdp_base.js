    ...
    H.Modal = (function () {
        ...
        D.method('createDom',function(settings){
            var mask = '<div class="modal-mask" id="modal-mask" style="position: fixed;width: 100%;height: 100%;top: 0; left: 0;z-index: 1000;background: rgba(0,0,0,0.4);"></div>',
                dialogDom = '<div id="modal-body" class="modal-body" style="position: fixed;width: '+settings.width+'px;height: '+settings.height+'px;top: 50%;left: 50%;margin-top:'+(-settings.height/2)+'px;margin-left:'+(-settings.width/2)+'px;overflow: hidden;background: #fff;z-index: 1001;">'+
                    ...
                    '<div class="modal-content" id="modal-content" style="width: 96%; height: '+(settings.height-90)+'px;padding: 20px;color: #666;overflow: auto;word-break: break-all;">'+settings.content+'</div>'+
